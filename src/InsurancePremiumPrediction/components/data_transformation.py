...
from src.InsurancePremiumPrediction.utils.utils import save_object
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                ...
                ('ordinalencoder',OrdinalEncoder(categories=[sex_categoires,smoker_categories,region_categories])),
                ('scaler',StandardScaler())
                ]
